        ...
        try (PreparedStatement stmt = dbConnect.preparedStatement(query)) {
 	        try (ResultSet rs = stmt.executeQuery()) {
 	            while(rs.next()) {
 	                ...
 	                guest.setId(rs.getString("user_id"));
 	                guest.setName(rs.getString("user_name"));
 	                guest.setEmail(rs.getString("user_email"));
 	                guest.setPassword(rs.getString("user_password"));
